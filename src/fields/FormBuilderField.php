...
use roundhouse\formbuilder\assetbundles\formbuilderfieldfield\FormBuilderFieldFieldAsset;
...
class FormBuilderField extends Field
{
    ...
    {
        return Craft::t('form-builder', 'FormBuilderField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'form-builder/_components/fields/FormBuilderField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(FormBuilderFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').FormBuilderFormBuilderField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'form-builder/_components/fields/FormBuilderField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
